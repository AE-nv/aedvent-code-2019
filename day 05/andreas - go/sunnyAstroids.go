...
func tests_part2(){
    fmt.Println("part 2")
    input_value = 1
    result := run(parseInput("3,9,8,9,10,9,4,9,99,-1,8"))
    fmt.Println(result)
    result  = run(parseInput("3,9,7,9,10,9,4,9,99,-1,8"))
    fmt.Println(result)
    result  = run(parseInput("3,3,1108,-1,8,3,4,3,99"))
    fmt.Println(result)
    result  = run(parseInput("3,3,1107,-1,8,3,4,3,99"))
    fmt.Println(result)
